...
var RoundProgressComponent = (function () {
    function RoundProgressComponent(_service, _easingFunctions, _defaults, _ngZone, _renderer) {
        ...
        this.grad = this._defaults.get('grad');
    ...
    __decorate([
        core_1.Input(), 
        __metadata('design:type', String)
    ], RoundProgressComponent.prototype, "grad", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', String)
    ], RoundProgressComponent.prototype, "disableGradient", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', String)
    ], RoundProgressComponent.prototype, "grad2", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Boolean)
    ], RoundProgressComponent.prototype, "on", void 0);
    __decorate([
        core_1.Output(), 
